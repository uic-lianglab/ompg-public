...
for (int ip=0; ip<3; ++ip) {
    ...
    plint *pairlistn_save;
    int npairn;
    plint *pairlistx_save;
    int npairx;
    plint *pairlistm_save;
    int npairm;
...
#undef PAIRLISTFROMARRAY
                    ...
                    pairlists.nextlist(&pairlistn_save,&npairn);
                    --npairn;
                    pairlists.nextlist(&pairlistx_save,&npairx);
                    --npairx;
                    pairlists.nextlist(&pairlistm_save,&npairm);
                    --npairm;
                    ALCH(
...
// END NBTHOLE OF DRUDE MODEL
            ...
            if (doLoweAndersen && p_i.hydrogenGroupSize) {
                ...
                for (k = 0; k < npairi; k++) {
                    ...
                    if (!p_j.hydrogenGroupSize) {
                        continue;
                    }
                    if (rand->uniform() > loweAndersenProb) {
                        continue;
                    }
...
#define EXCLUDED(X)
#define MODIFIED(X)
#include  "ComputeNonbondedBase2Std.h"
#undef NORMAL
#undef EXCLUDED
#undef MODIFIED
...
#define NOT_ALCHPAIR(X)
            BigReal myLambda;
            FEP(BigReal myLambda2;)
            BigReal myElecLambda;
            FEP(BigReal myElecLambda2;)
            BigReal myVdwLambda;
            FEP(BigReal myVdwLambda2;)
            BigReal myVdwShift;
            FEP(BigReal myVdwShift2;)
...
#define ALCH2(X)
            npairi = pairlist_from_pairlist(ComputeNonbondedUtil::cutoff2,
                                            ...
                                            r2_delta, r2list);
#include  "ComputeNonbondedBase2Std.h" // normal, direction 'up'
#undef ALCH1
#undef ALCH2
...
#define ALCH2(X) X
            npairi = pairlist_from_pairlist(ComputeNonbondedUtil::cutoff2,
                                            ...
                                            r2_delta, r2list);
#include  "ComputeNonbondedBase2Std.h" // normal, direction 'down'
#undef ALCH1
#undef ALCH2
...
#define ALCH2(X)
            npairi = pairlist_from_pairlist(ComputeNonbondedUtil::cutoff2,
                                            ...
                                            r2_delta, r2list);
            exclChecksum += npairi;
#include  "ComputeNonbondedBase2Std.h" // modified, direction 'up'
#undef ALCH1
#undef ALCH2
...
#define ALCH2(X) X
            npairi = pairlist_from_pairlist(ComputeNonbondedUtil::cutoff2,
                                            ...
                                            r2_delta, r2list);
            exclChecksum += npairi;
#include  "ComputeNonbondedBase2Std.h" // modified, direction 'down'
#undef ALCH1
#undef ALCH2
...
#define ALCH2(X)
            npairi = pairlist_from_pairlist(ComputeNonbondedUtil::cutoff2,
                                            ...
                                            r2_delta, r2list);
            exclChecksum += npairi;
#include  "ComputeNonbondedBase2Std.h"  //excluded, direction 'up'
#undef ALCH1
#undef ALCH2
...
#define ALCH2(X) X
            npairi = pairlist_from_pairlist(ComputeNonbondedUtil::cutoff2,
                                            ...
                                            r2_delta, r2list);
            exclChecksum += npairi;
#include  "ComputeNonbondedBase2Std.h"  //excluded, direction 'down'
#undef ALCH1
#undef ALCH2
