...
# Input subdirectory
BASE_CLUST_INPUT_DIR=$BASE_OUTPUT_DIR/d_clust_pdbs
# Output subdirectory
BASE_CLUST_OUTPUT_DIR=$BASE_OUTPUT_DIR/e_resample_ids
# Log directories
BASE_LOG_DIR=$DATA_DIR/logs
BASE_CLUST_LOG_DIR=$BASE_LOG_DIR/multi_loop/clust/e_resample_ids
...
MIN_COVERAGE=100
# Minimum total number of samples in final resampling
MIN_OUTPUT_COUNT=75000
