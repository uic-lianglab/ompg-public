...
BASE_FRAG_LIB_INPUT_DIR=$BASE_OUTPUT_DIR/frag_libs/c_csv_libs
BASE_FRAG_LIB_OUTPUT_DIR=$BASE_OUTPUT_DIR/frag_libs/d_bin_libs
...
do
    ...
    # If CSV count > 0, then this directory is a frag lib
...
echo "$(timestamp): Finished fragment library conversion from CSV to BIN"
