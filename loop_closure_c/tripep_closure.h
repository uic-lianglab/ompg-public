...
void matmul(double ma[][3], double mb[], double mc[]);
...
void coord_from_poly_roots(int *n_soln, double roots[], double r_n1[], double r_a1[], double r_a3[], double r_c3[], double r_soln_n[][3][3], double r_soln_a[][3][3], double r_soln_c[][3][3]);
...
void rotation_matrix(double q[], double U[][3]);
//!----------------------------------------------------------------------
//! Copyright (C) 2003 
